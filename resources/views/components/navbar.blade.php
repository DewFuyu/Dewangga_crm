        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="posts" :active="request()->is('posts')">List</x-nav-link>
              <x-nav-link href="master" :active="request()->is('master')">Master</x-nav-link>
              <x-nav-link href="member" :active="request()->is('member')">Member</x-nav-link>
              <x-nav-link href="proses" :active="request()->is('proses')">Proses</x-nav-link>
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Yume</div>
            {{-- <div class="text-sm font-medium text-gray-400">Yume@example.com</div> --}}
          </div>
